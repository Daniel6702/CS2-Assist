...
class RoundStartAlertSection(QtWidgets.QGroupBox):
    changed = QtCore.Signal()

    def __init__(self, parent=None) -> None:
        super().__init__("Round Start Alert", parent)
        ...
        self.file.setPlaceholderText("Play once when freezetime changes to live")
    ...
    def _browse(self) -> None:
        path, _ = QtWidgets.QFileDialog.getOpenFileName(
            self,
            "Select Round Start Alert Sound",
            "",
